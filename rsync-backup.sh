...
# -  exclude particular directories that do not require being backed up
# -  utilize the --archive option to maintain ownership/permission for the files
# -  utilize the -z option to compress files in transit
# -  produce a local log file [/var/log/rsync-backup.log] for additional troubleshooting/debugging
# -  display the progress of the transfer and the stats of the transfer upon completion
